...
class Project
  ...
  module GeneratedAssociationMethods
    ...
    sig { returns(T::Array[T.untyped]) }
    def schema_snapshot_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def schema_snapshot_ids=(ids); end

    # This method is created by ActiveRecord on the `Project` class because it declared `has_many :schema_snapshots`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::SchemaSnapshot::PrivateCollectionProxy) }
    def schema_snapshots; end

    sig { params(value: T::Enumerable[::SchemaSnapshot]).void }
    def schema_snapshots=(value); end
  end
  ...
  module GeneratedAttributeMethods
    ...
    def database_url_before_last_save; end

    sig { returns(T.untyped) }
    def database_url_before_type_cast; end

    sig { returns(T::Boolean) }
    def database_url_came_from_user?; end

    sig { returns(T.nilable([::String, ::String])) }
    def database_url_change; end

    sig { returns(T.nilable([::String, ::String])) }
    def database_url_change_to_be_saved; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def database_url_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def database_url_in_database; end

    sig { returns(T.nilable([::String, ::String])) }
    def database_url_previous_change; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def database_url_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def database_url_previously_was; end

    sig { returns(T.nilable(::String)) }
    def database_url_was; end

    sig { void }
    def database_url_will_change!; end
    ...
    sig { returns(T.nilable([::String, ::String])) }
    def saved_change_to_database_url; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_database_url?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_database_url?(from: T.unsafe(nil), to: T.unsafe(nil)); end
