...
export {}
declare global {
  const APP_DESCRIPTION: typeof import('~/helpers/app')['APP_DESCRIPTION']
  const APP_NAME: typeof import('~/helpers/app')['APP_NAME']
  ...
  const BackIcon: typeof import('~/components/icons')['BackIcon']
  ...
  const InvitationIcon: typeof import('~/components/icons')['InvitationIcon']
  ...
  const useNormalizeUrl: typeof import('~/helpers/utils')['useNormalizeUrl']
