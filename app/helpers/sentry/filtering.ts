...
const isModuleImportFailedMessage = (message: string): boolean =>
  message === "Importing a module script failed.";

const isFetchFailedMessage = (message: string): boolean =>
  message.startsWith("Failed to fetch");

const isScriptLoadFailedMessage = (message: string): boolean =>
