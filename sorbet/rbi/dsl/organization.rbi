...
class Organization
  ...
  def display_photo; end

  sig { params(attachable: T.untyped).returns(T.untyped) }
  def display_photo=(attachable); end
  ...
  module GeneratedAssociationMethods
    ...
    def build_display_photo_attachment(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::ActiveStorage::Blob) }
    def build_display_photo_blob(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::User) }
    def build_owner(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::ActiveStorage::Attachment) }
    def create_display_photo_attachment(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::ActiveStorage::Attachment) }
    def create_display_photo_attachment!(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::ActiveStorage::Blob) }
    def create_display_photo_blob(*args, &blk); end
    ...
    def display_photo_attachment; end

    sig { params(value: T.nilable(::ActiveStorage::Attachment)).void }
    def display_photo_attachment=(value); end

    sig { returns(T.nilable(::ActiveStorage::Blob)) }
    def display_photo_blob; end

    sig { params(value: T.nilable(::ActiveStorage::Blob)).void }
    def display_photo_blob=(value); end
    ...
    sig { returns(T.nilable(::ActiveStorage::Attachment)) }
    def reload_display_photo_attachment; end

    sig { returns(T.nilable(::ActiveStorage::Blob)) }
    def reload_display_photo_blob; end

    sig { returns(T.nilable(::User)) }
    def reload_owner; end

    sig { void }
    def reset_display_photo_attachment; end

    sig { void }
    def reset_display_photo_blob; end
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(args: T.untyped, blk: T.untyped).returns(PrivateAssociationRelation) }
    def with_attached_display_photo(*args, &blk); end
